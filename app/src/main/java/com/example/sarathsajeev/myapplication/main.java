...
public class main extends Activity {
    ...
    private Button btnLogout,chart,add_details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chart = (Button) findViewById(R.id.btnchart);
        add_details = (Button) findViewById(R.id.btnadd);
        ...
        add_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(main.this,entry.class);
                startActivity(intent);
